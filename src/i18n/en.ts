...
export const en: Dictionary = {
  ...
  featureBento: {
    ...
    cards: {
      ...
      animatedImages: {
        title: "Animated Image Support",
        desc: "APNG and GIF avatars stay fully animated on the main stage, while previews remain static.",
        apng: "APNG",
        gif: "GIF",
        png: "Static PNG",
        note: "Full animation on the main stage",
      },
      speakHold: {
        title: "Speak Hold Time",
        desc: "Keep your avatar in the Speaking state briefly after you stop talking, so it never flickers during short pauses.",
        speak: "Speaking",
        hold: "Hold",
        note: "Ideal for APNG / GIF avatars",
      },
      lightweight: {
  ...
  systemSecurity: {
    ...
    requirements: [
      ...
      { k: "RAM", v: "500 MB (Application is < 80MB)" },
...
howToUse: {
  ...
  changelog: {
    ...
    desc: "Stay up to date with the latest PTube improvements and fixes.",
    viewChangelog: "View on GitHub",
    latest: "Latest Release",
    loading: "Loading release notes...",
    published: "Published",
    linkRelease: "View release on GitHub",
  },
  footer: {
