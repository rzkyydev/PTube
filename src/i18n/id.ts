...
export const id: Dictionary = {
  ...
  featureBento: {
    ...
    cards: {
      ...
      animatedImages: {
        title: "Dukungan Gambar Animasi",
        desc: "Avatar APNG dan GIF tetap bergerak penuh di panggung utama, sementara pratinjau tetap statis.",
        apng: "APNG",
        gif: "GIF",
        png: "PNG Statis",
        note: "Animasi penuh di panggung utama",
      },
      speakHold: {
        title: "Speak Hold Time",
        desc: "Jaga avatar tetap di status Speaking sebentar setelah Anda berhenti bicara, agar tidak berkedip saat jeda singkat.",
        speak: "Berbicara",
        hold: "Tahan",
        note: "Ideal untuk avatar APNG/GIF",
      },
      lightweight: {
  ...
  changelog: {
    eyebrow: "Changelog",
    title: "Rilis Terbaru",
    desc: "Pantau peningkatan dan perbaikan terbaru PTube.",
    viewChangelog: "Lihat di GitHub",
    latest: "Rilis Terbaru",
    loading: "Memuat catatan rilis...",
    published: "Diterbitkan",
    linkRelease: "Lihat rilis di GitHub",
  },
  footer: {
